			...
			<div id="wrapper">
				...
				<!-- Main -->
					<div id="main">
						...
						<input type="submit" value="Ordenar por nombre" name="ordenarn"></form>
						</div>	
						<div id="f">
						<form method="post" action="fecha.php"> <input type="submit" value="Ordenar por fecha" name="ordenarf"> </form>
						</div>
						<!-- Post -->
...
$conex= mysql_connect("localhost","root","")
		...
		if(isset($_POST['ordenarn'])){
	$sql = "SELECT * FROM scraping order by nombre";
